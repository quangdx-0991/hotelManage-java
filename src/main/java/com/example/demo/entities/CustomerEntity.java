...
public class CustomerEntity implements Serializable {
    ...
    @Column(name = "col_customer_id", nullable = false, unique = true, columnDefinition = ColumnDefinitionConstant.INTEGER)
	...
	@JsonView(Views.Public.class)
	@Column(name = "col_phone", columnDefinition = ColumnDefinitionConstant.CHAR)
	...
	@JsonView(Views.Public.class)
	@Column(name = "col_nationality", columnDefinition = ColumnDefinitionConstant.NVARCHAR)
